...
module.exports.run = async (bot, message, args) => {
    ...
    // Kanaal waar reviews inkomen opzoeken.「👀」reviews'
    var reviewChannel = message.guild.channels.cache.find(channel => channel.name === "「👀」reviews");
...
module.exports.help = {
    name: "review",
    description: "Vind je NBR tof? Laat een review achter!",
    category: "Algemeen"
}